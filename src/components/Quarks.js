   ...
   render(){
    return(
        ...
        <div className="container-fluid ">
            <h1 className="mb-3 text-center">Quarks</h1>
            <div class="jumbotron jumbotron-fluid"  style={{ backgroundImage: `url('images/quarks.png')`,backgroundSize:"100% 100%", height:"400px"}}>
            </div>
