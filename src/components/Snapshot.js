...
class Snapshot extends React.Component{
   ...
   render(){
    return(
        ...
        <CardImg top width="100%" src="/events/SNAPSHOT.png" alt="Card image cap" />
        ...
        <p className='eventtext'>Snapshot is a virtual event that encourages aspiring photographers to showcase their creativity and perceive photogenic beauty. The event's concept is to capture the fascinating idea behind every click in materials and metallurgical domains.</p>
        <CardTitle tag="h1">Event Details</CardTitle>
        <ul>
        <li className="eventtext">
              All materials-related snapshots with a justifying tagline will be
              considered.
            </li>
            <li  className="eventtext">
        ...
        {this.props.event.Snapshot ? <p>You have registered to this event !</p> : <p>Click the Button to register in this event.</p>}
