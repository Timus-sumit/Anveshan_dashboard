   ...
   render(){
    return(
        ...
        <div className="container-fluid ">
            <h1 className="mb-3 text-center">Snapshot</h1>
            <div class="jumbotron jumbotron-fluid"  style={{ backgroundImage: `url('images/snapshot.png')`,backgroundSize:"100% 100%", height:"400px"}}>
            </div>
            <div className="text-center">
            <p><b>Snapshot is a virtual event that encourages aspiring photographers to showcase their
            creativity and perceive photogenic beauty. The event's concept is to capture the
            fascinating idea behind every click in materials and metallurgical domains.
            </b></p>
            </div>
        </div>
